...
export class EmployeeOrderController {
  ...
  async find(
    ...
    return this.employeeRepository.ordersAssigned(id).find(filter);
  }
  ...
  async create(
    ...
    return this.employeeRepository.ordersAssigned(id).create(order);
  }
  ...
  async patch(
    ...
    return this.employeeRepository.ordersAssigned(id).patch(order, where);
  }
  ...
  async delete(
    ...
    return this.employeeRepository.ordersAssigned(id).delete(where);
  }
}
